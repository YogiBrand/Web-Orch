...
export function ComputerUsePlayground() {
  ...
  const { data: categorizedModels } = useQuery({
    queryKey: ['/api/models/categorized'],
  });
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Constrained container so columns start under the page header */}
        <div className="mx-auto w-full max-w-6xl px-6 flex gap-6 overflow-hidden">
        {/* Left Panel - Task Creation */}
        <div className="w-80 shrink-0 bg-white dark:bg-gray-800 border-r flex flex-col">
                        ...
                        {categorizedModels ? (
                          <>
                            {categorizedModels.local?.length > 0 && (
                              <>
                                <div className="px-2 py-1.5 text-xs font-semibold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/20">
                                  🏠 LOCAL MODELS
                                </div>
                                {categorizedModels.local.map((model: any) => (
                            ...
                            {categorizedModels.free?.length > 0 && (
                              <>
                                <div className="px-2 py-1.5 text-xs font-semibold text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20">
                                  🆓 FREE MODELS
                                </div>
                                {categorizedModels.free.map((model: any) => (
                                  <SelectItem key={model.id} value={model.id} className="pl-4">
                                    <div className="flex items-center gap-2">
                            ...
                            {categorizedModels['premium-vision']?.length > 0 && (
                              <>
                                <div className="px-2 py-1.5 text-xs font-semibold text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20">
                                  ✨ PREMIUM VISION
                                </div>
                                {categorizedModels['premium-vision'].map((model: any) => (
                                  <SelectItem key={model.id} value={model.id} className="pl-4">
                                    <div className="flex items-center gap-2">
                            ...
                            {categorizedModels.coding?.length > 0 && (
                              <>
                                <div className="px-2 py-1.5 text-xs font-semibold text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/20">
                                  💻 CODING SPECIALISTS
                                </div>
                                {categorizedModels.coding.map((model: any) => (
                                  <SelectItem key={model.id} value={model.id} className="pl-4">
                                    <div className="flex items-center gap-2">
                            ...
                            {categorizedModels['open-source']?.length > 0 && (
                              <>
                                <div className="px-2 py-1.5 text-xs font-semibold text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/20">
                                  🔓 OPEN SOURCE
                                </div>
                                {categorizedModels['open-source'].map((model: any) => (
                                  <SelectItem key={model.id} value={model.id} className="pl-4">
                                    <div className="flex items-center gap-2">
                          ...
                          // Fallback to regular model list
                  ...
                  {dataSource === 'crm' && (
                    <div>
                      ...
                      <Select value={selectedCrmList} onValueChange={setSelectedCrmList}>
                        ...
                        <SelectContent>
                          {crmLists && Array.isArray(crmLists) && crmLists.map((list: any) => (
        ...
        {/* Right Panel - Results */}
        <div className="flex-1 flex flex-col bg-white dark:bg-gray-800 rounded-sm">
          <div className="p-6 pb-4 border-b">
            <h2 className="text-lg font-semibold mb-2">Results</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">Test browser automation tasks</p>
          </div>
          
          <Tabs defaultValue="overview" className="flex-1 flex flex-col px-6 py-4">
            ...
            <TabsContent value="overview" className="flex-1 px-0 py-6">
              <Card>
                <CardHeader>
            ...
            <TabsContent value="logs" className="flex-1 px-0 py-6">
            ...
            <TabsContent value="steps" className="flex-1 px-0 py-6">
              <Card className="h-full">
                <CardHeader>
            ...
            <TabsContent value="files" className="flex-1 px-0 py-6">
              <Card className="h-full">
                <CardHeader>
